...
CREATE TABLE public.books (
    ...
    description text,
    book_file_name character varying(512)
);
...
func insertData(db *sql.DB) error {
	...
	// insert one book
	stmt = `
	insert into books (title, author_id, publication_year, created_at, updated_at, slug, description, book_file_name)
	values
	('My Book', 1, 2020, '2020-01-01 01:00:00', '2020-01-01 01:00:00', 'my-book', 'My description', 'My Book File.fb2')`
	_, err = db.Exec(stmt)
	if err != nil {
		return err
	}
